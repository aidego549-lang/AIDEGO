    ...
    <main className="min-h-screen bg-white flex flex-col md:flex-row relative overflow-hidden pt-32 md:pt-0">
          ...
          <div className="max-w-xl">
            ...
            >
              <h2 className="text-5xl lg:text-7xl font-heading font-bold text-white mb-8 tracking-tight leading-[1.1]">
                Start your <br />premium <span className="text-primary italic">journey.</span>
              </h2>
      ...
      <div className="w-full md:w-1/2 lg:w-[45%] flex flex-col justify-center py-16 md:pt-32 px-8 sm:px-12 lg:px-24 bg-white relative z-20 shadow-[-50px_0_100px_rgba(0,0,0,0.1)]">
        <div className="max-w-md w-full mx-auto">
          ...
          >
            <div className="mb-10">
              <h1 className="text-4xl font-heading font-bold tracking-tight text-text mb-4">Create account</h1>
              <p className="text-text-muted font-medium text-lg leading-relaxed">Join AideGo and experience the difference today.</p>
            </div>

            <div className="space-y-6">
              <button className="w-full flex items-center justify-center gap-4 bg-white border border-border/60 py-4 rounded-2xl font-bold text-text hover:bg-surface hover:border-primary/40 transition-all active:scale-[0.98] shadow-sm group">
              ...
              <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
                ...
                <p className="text-[11px] text-text-muted font-medium leading-relaxed pt-2 text-center">
                  By clicking Create Account, you acknowledge that you have read and agree to our <Link href="#" className="text-primary font-bold">Terms</Link> and <Link href="#" className="text-primary font-bold">Privacy Policy</Link>.
                </p>

                <Button fullWidth className="py-5 font-bold rounded-2xl mt-4 shadow-2xl shadow-primary/20 hover:shadow-primary/30 hover:-translate-y-0.5 active:scale-[0.98] transition-all bg-text text-white hover:bg-primary">
                  Create free account
                </Button>
              </form>
